...
/**
 * Represents a specific category, such as "Textbook".
...
class CategoryCollection extends BaseCollection {
   ...
   *                    description: 'UH Textbooks needed for classes at UH Manoa' });
   * @param { Object } description Object with keys name and description.
   * Name must be previously undefined. Description is optional.
   * Creates a "slug" for this name and stores it in the slug field.
   * @throws {Meteor.Error} If the category definition includes a defined name.
   ...
   * @param categoryID A category docID.
   * @returns { String } A category name.
   ...
   * @throws { Meteor.Error } If name is not associated with a Category.
   */
  findID(name) {
   ...
   * @throws { Meteor.Error } If any instance is not a Category name.
   */
  findIDs(names) {
